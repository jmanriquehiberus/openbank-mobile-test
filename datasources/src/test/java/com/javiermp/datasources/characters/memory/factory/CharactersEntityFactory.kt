package com.javiermp.datasources.characters.memory.factory
...
class CharactersEntityFactory {
    ...
    companion object Factory {
        ...
        private fun makeImageEntity() = Image(DataFactory.getRandomString(5), DataFactory.getRandomString(5))
        ...
        private fun makeComicSummaryEntity(count: Int): List<ComicSummary> {
            ...
            repeat(count) {
                comicSummaries.add(ComicSummary(DataFactory.getRandomString(5), DataFactory.getRandomString(5)))
            }
        ...
        private fun makeStorySummaryEntity(count: Int): List<StorySummary> {
            ...
            repeat(count) {
                storySummaries.add(StorySummary(DataFactory.getRandomString(5), DataFactory.getRandomString(5), DataFactory.getRandomString(5)))
            }
        ...
        private fun makeSeriesSummaryEntity(count: Int): List<SeriesSummary> {
            ...
            repeat(count) {
                seriesSummaries.add(SeriesSummary(DataFactory.getRandomString(5), DataFactory.getRandomString(5)))
            }
